    ...
    easyrtc.getRoomList(function (roomList) {
        ...
        for (var roomName in roomList) {
            if (roomList[roomName].numberClients < 2) {
                ...
                windowOpen("/room/" + roomName + "", "room", 0, screen.height, screen.width / 2, screen.height).focus();
        ...
        windowOpen("/room/" + easyrtcid + "", "room", 0, screen.height, screen.width / 2, screen.height).focus();
